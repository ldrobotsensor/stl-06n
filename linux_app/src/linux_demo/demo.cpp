...
int main(int argc, char **argv) {
  ...
  if (argc < 4) {
    ...
    LDS_LOG_WARN("./ldlidar_stl STL06N serialcom /dev/ttyUSB0","");
    LDS_LOG_WARN("-----------------","");
    ...
    LDS_LOG_WARN("./ldlidar_stl STL06N networkcom_tcpclient 192.168.1.200 2000","");
    exit(EXIT_FAILURE);
  }
  ...
  node->EnableFilterAlgorithnmProcess(false);
